; turn_to action updated to prevent turning from and to the same direction
...
(:action turn_to
 ...
 :precondition
	(and (satellite ?s) (direction ?d_new) (direction ?d_prev)  (pointing ?s ?d_prev) (not (pointing ?s ?d_new)))
 :effect
