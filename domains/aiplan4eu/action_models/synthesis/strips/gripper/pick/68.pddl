...
(define (problem strips-gripper-x-4)
    ...
    (:goal
        (and (room rooma) (room roomb) (ball ball9) (ball ball2) (ball ball4) (ball ball3) (ball ball7) (ball ball10) (ball ball8) (ball ball6) (ball ball1) (ball ball5) (at-robby rooma) (at ball6 rooma) (at ball7 rooma) (at ball9 rooma) (at ball3 rooma) (at ball4 rooma) (at ball8 rooma) (at ball10 rooma) (at ball1 rooma) (gripper left) (gripper right) (carry ball5 left) (carry ball2 right))
    )
